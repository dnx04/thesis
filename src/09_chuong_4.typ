...
Đối với bộ dữ liệu đánh giá độ chính xác bootstrap, chúng tôi tạo ra các bộ dữ liệu mô phỏng bằng công cụ Seq-gen. Bộ dữ liệu này bao gồm ba bộ dữ liệu DNA và hai bộ dữ liệu protein, mỗi loại chứa 200 MSA. Các bộ dữ liệu được tạo ra bằng mô hình Yule-Harding để mô phỏng các mối quan hệ tiến hóa.
...
Chúng tôi đã sử dụng các bộ dữ liệu lớn, bao gồm Plant ($38 times 432014$), Bird ($52 times 4519041$), Insect ($144 times 383161$), và Mammal ($90 times 1848196$) từ @minh2021qmaker. Chúng tôi so sánh hiệu suất của một số phương pháp trên các bộ căn chỉnh chuỗi lớn (MSAs) này bằng cách sử dụng cả mô hình chi phí đồng nhất và không đồng nhất. Kết quả được tóm tắt trong @tab-fitch-big và @tab-sankoff-big, trình bày các điểm tối ưu tính parsimon cao nhất và thời gian chạy (tính bằng giờ) của từng phương pháp.
